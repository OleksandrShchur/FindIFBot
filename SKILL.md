...
- Maintenance endpoints:
  ...
  - `POST /api/maintenance/daily-statistics` — upserts one Kyiv-day row in `ChannelDailyStatistics` (live bot-user/subscriber snapshots; `PostsCount` = rolling last 24h) and sends a monospace table to the logs channel
